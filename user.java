...
public class user extends data {
    ...
    public boolean needsblock(String nexttime){
        ...
        Matcher t1 = p.matcher(times[0]);
        Matcher t2 = p.matcher(nexttime);
        t1.find();
        t2.find();
        String seconds1 = t1.group(3);
        String seconds2 = t2.group(3);
        Integer s1 = Integer.parseInt(seconds1);
        Integer s2 = Integer.parseInt(seconds2);
        //System.out.println((s1+20)%60);
    ...
    public void addtime(String newtime){
        ...
        if (times[0] == null){times[0] = nt;}
        else if (times[1] == null){times[1] = nt;}
        else if (times[2]==null){times[2]= nt;}
        else {
    ...
    public static void main(String[] args){
        //user testuser = new user("testname", "100", 5, "blah:blah:blah:40 blah");
        //testuser.addtime("blah");
        //testuser.addtime("blah");
        //System.out.print(testuser.within20seconds("blah:blah:blah:01 blah"));
    }
}
